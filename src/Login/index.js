    ...
    render() {
        return (
            <Grid className="login" textAlign="center" verticalAlign="middle">
                <Grid.Column style={{ maxWidth: 450, backgroundColor: "blue" }}>
                    <Header className="title" textAlign="center">
                        <h2>Barometer Wellness</h2>
                    </Header>
                    <Form onSubmit={this.handleSubmit}>
                        <Segment style={{ backgroundColor="grey" }} stacked>
                        <h3 style={{ backgroundColor: "white" }}>Username</h3>
                        <Form.Input fluid icon="user" iconPosition="left" placeholder="username" type="text" name="username" onChange={this.handleChange} />
                        <h3 style={{ backgroundColor: "white" }}>Password</h3>
                        ...
                        {this.state.notValid ? (
                            <div style={{ fontSize: "25px", color: "red", fontWeight: "bold", textShadow: "-1px 0 black, 0 1px black, 1px 0 black, 0 -1px black" }}>
